...
const ABILITIES = [
  ...
  { id: 'poison_spray',      name: 'ROCIO VENENOSO',         rarity: 'common', icon: '\u2601', description: 'Roc\u00eda un cono de niebla t\u00f3xica en la direcci\u00f3n de apuntado de la torreta, envenenando a los enemigos durante 4 segundos.', baseStats: 'DOT: 8/tick | DUR: 4s | CD: 8s' },
  ...
  { id: 'armor_plating',     name: 'BLINDAJE',               rarity: 'common', icon: '\u25A3', description: 'Aplica una reducci\u00f3n de da\u00f1o plana temporal a todos los impactos entrantes durante 6 segundos.',                      baseStats: 'REDUC: 10 | DUR: 6s | CD: 12s' },
  ...
  { id: 'grease_slick',      name: 'CHARCO RESBALADIZO',     rarity: 'common', icon: '\u224B', description: 'Deja un charco resbaladizo bajo la torreta que frena a los enemigos que lo atraviesan en un 50%.',                            baseStats: 'SLOW: 50% | DUR: 6s | CD: 8s' },
  { id: 'ricochet_round',    name: 'BALA REBOTIN',           rarity: 'common', icon: '\u2297', description: 'Dispara una sola bala de alta velocidad que rebota en los bordes de la pantalla hasta 4 veces.',                             baseStats: 'DMG: 55 | REBOTES: 4 | CD: 6s' },
  ...
  { id: 'turret_overclock',  name: 'SOBREVELOCIDAD TORRETA', rarity: 'common', icon: '\u2699', description: 'Sobrecarga temporalmente la torreta, aumentando su cadencia de fuego en un 50% durante 4 segundos.',                         baseStats: 'CADENCIA: +50% | DUR: 4s | CD: 12s' },
  ...
  { id: 'hail_storm',        name: 'TORMENTA DE GRANIZO',    rarity: 'common', icon: '\u2735', description: 'Cubre un \u00e1rea aleatoria de la pantalla con 20 peque\u00f1os proyectiles de hielo que causan poco da\u00f1o cada uno.',    baseStats: 'DMG: 12 | PROY: 20 | CD: 8s' },
  ...
  { id: 'web_trap',          name: 'TRAMPA DE TELARANA',     rarity: 'common', icon: '\u22C6', description: 'Dispara una telara\u00f1a que inmoviliza al enemigo m\u00e1s cercano durante 3 segundos.',                                   baseStats: 'ROOT: 3s | CD: 8s' },
  ...
  { id: 'void_rift',           name: 'GRIETA DEL VACIO',       rarity: 'rare', icon: '\u27D0', description: 'Abre una grieta en un grupo aleatorio de enemigos que causa da\u00f1o continuo y atrae a los enemigos cercanos durante 4 segundos.', baseStats: 'DMG: 15/tick | DUR: 4s | CD: 18s' },
  ...
  { id: 'time_slow_field',     name: 'CAMPO RALENTIZADOR',     rarity: 'rare', icon: '\u221E', description: 'Proyecta un campo localizado que frena a todos los enemigos dentro de \u00e9l al 20% de velocidad durante 5 segundos.',         baseStats: 'SLOW: 80% | DUR: 5s | CD: 20s' },
  ...
  { id: 'shockwave_pulse',     name: 'PULSO DE ONDA DE CHOQUE',rarity: 'rare', icon: '\u224B', description: 'Emite 3 anillos de onda de choque expansivos secuenciales que cada uno causa da\u00f1o, con un ligero retraso entre ellos.',     baseStats: 'DMG: 45 | ONDAS: 3 | CD: 14s' },
  ...
  { id: 'execute_protocol',    name: 'PROTOCOLO DE EJECUCION', rarity: 'rare', icon: '\u2297', description: 'Mata instant\u00e1neamente a todos los enemigos con menos del 20% de salud en pantalla.',                                       baseStats: 'UMBRAL: 20% | CD: 25s' },
  ...
  { id: 'frost_nova',          name: 'NOVA DE ESCARCHA',       rarity: 'rare', icon: '\u25A3', description: 'Explota en una r\u00e1faga de escarcha que congela a todos los enemigos en rango medio durante 2 segundos y luego los rompe por da\u00f1o adicional.', baseStats: 'CONG: 2s | DMG: 70 | CD: 18s' },
  ...
  { id: 'bullet_storm',         name: 'TORMENTA DE BALAS',        rarity: 'epic', icon: '\u2739', description: 'Desata una tormenta de balas de 5 segundos que dispara 5 balas por fotograma en direcciones aleatorias llenando toda la arena.', baseStats: 'DMG: 15 | DUR: 5s | CD: 30s' },
  ...
  { id: 'plague_cloud',         name: 'NUBE DE PLAGA',            rarity: 'epic', icon: '\u224B', description: 'Genera una nube t\u00f3xica masiva que llena el 40% de la pantalla, causando da\u00f1o de veneno acumulativo y reduciendo la velocidad de los enemigos en un 40% durante 8 segundos.', baseStats: 'DOT: 15 | SLOW: 40% | CD: 35s' },
  ...
  { id: 'cryo_freeze',          name: 'CONGELACION CRIOGENICA',   rarity: 'epic', icon: '\u2744', description: 'Congela instant\u00e1neamente a todos los enemigos en pantalla durante 3 segundos, impidi\u00e9ndoles moverse y causando que se rompan con da\u00f1o adicional al ser golpeados.', baseStats: 'CONG: 3s | BONUS: 50% | CD: 35s' },
  ...
  { id: 'temporal_stasis',      name: 'ESTASIS TEMPORAL',         rarity: 'epic', icon: '\u23E3', description: 'Pausa a todos los enemigos en su lugar durante 4 segundos mientras la torreta contin\u00faa disparando normalmente.', baseStats: 'PAUSA: 4s | CD: 35s' },
  ...
  { id: 'spectral_bomb',        name: 'BOMBA ESPECTRAL',          rarity: 'epic', icon: '\u25A7', description: 'Despliega una bomba espectral invisible para los enemigos que detona cuando 5 o m\u00e1s enemigos est\u00e1n en su radio, causando da\u00f1o masivo.', baseStats: 'DMG: 180 | ACTIVA: 5 ENE | CD: 30s' },
  { id: 'rewind_damage',        name: 'REBOBINAR DANO',           rarity: 'epic', icon: '\u21DD', description: 'Rebobina a todos los enemigos a sus posiciones y valores de vida de hace 4 segundos, revirtiendo efectivamente los \u00faltimos 4 segundos de su curaci\u00f3n/avance.', baseStats: 'REBOBINA: 4s | CD: 35s' },
  ...
  // ── Legendary ──
  { id: 'cosmic_ray',          name: 'RAYO COSMICO',          rarity: 'legendary', icon: '\u2600', description: 'Llama a un rayo c\u00f3smico masivo desde arriba que barre toda la arena causando 400 de da\u00f1o a todo lo que toca.', baseStats: 'DMG: 400 | CD: 45s' },
  ...
  { id: 'time_stop',           name: 'DETENCION TEMPORAL',    rarity: 'legendary', icon: '\u221E', description: 'Detiene todo el tiempo para los enemigos durante 6 segundos \u2014 se congelan completamente mientras la torreta dispara a doble velocidad durante este periodo.', baseStats: 'PAUSA: 6s | DISPARO: x2 | CD: 50s' },
  ...
  { id: 'infinite_turret',     name: 'TORRETA INFINITA',      rarity: 'legendary', icon: '\u2B21', description: 'Genera 8 copias id\u00e9nticas de la torreta que disparan en todas direcciones simult\u00e1neamente durante 12 segundos.', baseStats: 'COPIAS: 8 | DUR: 12s | CD: 45s' },
  ...
  { id: 'omega_shield',        name: 'ESCUDO OMEGA',          rarity: 'legendary', icon: '\u25A3', description: 'Activa un escudo impenetrable durante 8 segundos; cuando expira, detona absorbiendo todo el da\u00f1o recibido y devolvi\u00e9ndolo como \u00e1rea.', baseStats: 'INMUNE: 8s | RETORNO: x1.5 | CD: 45s' },
  ...
  { id: 'reaper_scythe',       name: 'GUADANA DEL SEGADOR',   rarity: 'legendary', icon: '\u2694', description: 'Invoca la guada\u00f1a del Segador que barre la pantalla 3 veces, cada barrido causando 350 de da\u00f1o a todos los enemigos en su arco.', baseStats: 'DMG: 350 | BARRIDOS: 3 | CD: 45s' },
  { id: 'eternal_storm',       name: 'TORMENTA ETERNA',       rarity: 'legendary', icon: '\u26A1', description: 'Invoca una tormenta eterna que dura 15 segundos: rayos aleatorios golpean enemigos cada 0.5 segundos por 200 de da\u00f1o cada uno.', baseStats: 'DMG: 200/rayo | DUR: 15s | CD: 50s' },
  ...
  { id: 'entropy_bomb',        name: 'BOMBA DE ENTROPIA',     rarity: 'legendary', icon: '\u2622', description: 'Planta una bomba de entrop\u00eda que acumula poder durante 5 segundos; luego detona causando da\u00f1o igual al da\u00f1o total recibido por la torreta durante esa ventana x10.', baseStats: 'MULT: x10 | CD: 45s' },
  { id: 'legion_protocol',     name: 'PROTOCOLO LEGION',      rarity: 'legendary', icon: '\u25B2', description: 'Activa el Protocolo Legi\u00f3n: despliega 12 drones de combate aut\u00f3nomos que cada uno dispara independientemente durante 15 segundos.', baseStats: 'DMG: 30 | DRONES: 12 | CD: 50s' },
  ...
  { id: 'overdrive_core',      name: 'NUCLEO SOBREVELOCIDAD', rarity: 'legendary', icon: '\u269B', description: 'Sobrecarga el n\u00facleo de la torreta durante 10 segundos: las balas se dividen en 3 al golpear cada enemigo, cada una causando el 40% del da\u00f1o original.', baseStats: 'SPLIT: x3 | DUR: 10s | CD: 50s' },
