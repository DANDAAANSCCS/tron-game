...
const ABILITY_ICONS = {
  emp:'\u26A1', shield:'\u25A3', rapidfire:'\u21AF', chain:'\u269B', freeze:'\u2744', orbital:'\u2604',
  plasma_burst:'\u25C6', static_field:'\u21AF', repair_nanobots:'\u2727', shrapnel_mine:'\u25B2',
  targeting_boost:'\u25CE', poison_spray:'\u2601', energy_wall:'\u2295', scatter_shot:'\u2726',
  blind_flash:'\u2600', bullet_magnet:'\u21DD', gravity_pull:'\u25CB', armor_plating:'\u25A3',
  spark_trail:'\u2301', micro_missiles:'\u25BD', decoy_signal:'\u2234', voltaic_aura:'\u229B',
  grease_slick:'\u224B', ricochet_round:'\u2297', smoke_screen:'\u25C7', overcharge_shot:'\u2605',
  seismic_tap:'\u25B3', turret_overclock:'\u2699', acid_splash:'\u22A0', burst_shield:'\u229E',
  energy_spike:'\u2739', hail_storm:'\u2735', crit_boost:'\u2666', web_trap:'\u22C6',
  flare_launch:'\u2605', repulsor_blast:'\u2660',
  twin_barrels:'\u22BF', chain_burn:'\u2622', void_rift:'\u27D0', kill_trigger_bomb:'\u2620',
  drone_sentry:'\u23E3', lifesteal_rounds:'\u2665', tesla_coil:'\u238A', mirror_wall:'\u25A7',
  vulnerability_mark:'\u2B1F', phantom_barrage:'\u25C7', time_slow_field:'\u221E', concussive_blast:'\u25C6',
  orbital_mine_ring:'\u23DA', shockwave_pulse:'\u224B', elemental_infusion:'\u2735', spectral_copy:'\u22C6',
  execute_protocol:'\u2297', nano_swarm:'\u229B', kinetic_surge:'\u21AF', scatter_mines:'\u25BD',
  pulse_shield:'\u2295', dark_matter_round:'\u25CF', beacon_of_weakness:'\u2663', cluster_bomb:'\u25B2',
  sonic_boom:'\u224B', sniper_scope:'\u25CE', overclock_ammo:'\u2301', frost_nova:'\u2744',
  momentum_field:'\u21DD', toxin_canister:'\u2601',
  blackhole_seed:'\u221E', bullet_storm:'\u2739', time_reversal:'\u2234', ion_cannon:'\u22BF',
  quantum_mirror:'\u27D0', plague_cloud:'\u2601', turret_fortress:'\u2B21', gravity_inverter:'\u25C7',
  energy_leech:'\u2665', cryo_freeze:'\u2744', death_mark:'\u2620', overload_field:'\u26A1',
  antimatter_shell:'\u22A0', phase_shift:'\u25CB', gravity_well_array:'\u238A', singularity_bomb:'\u2726',
  neural_disruptor:'\u229B', gravity_lens:'\u25CE', chain_reaction:'\u269B', temporal_stasis:'\u23E3',
  photon_barrier:'\u2295', power_surge:'\u2699', warp_field:'\u27D0', temporal_dilation:'\u2234',
  spectral_bomb:'\u25A7', rewind_damage:'\u21DD', prism_array:'\u2735', dark_resonance:'\u22C6',
  nanobot_swarm_repair:'\u2727', nano_heal_aura:'\u229E',
  cosmic_ray:'\u2600', apocalypse_nova:'\u2726', time_stop:'\u221E', supernova_collapse:'\u2605',
  dimensional_rift:'\u25C7', infinite_turret:'\u2B21', total_annihilation:'\u22A0', vampire_field:'\u2665',
  matrix_hack:'\u27D0', solar_flare:'\u2600', omega_shield:'\u25A3', god_mode:'\u2605',
  paradox_loop:'\u23E3', wrath_of_cosmos:'\u224B', infinity_mirror:'\u25CE', reaper_scythe:'\u2694',
  eternal_storm:'\u26A1', void_collapse:'\u22BF', entropy_bomb:'\u2622', legion_protocol:'\u2694',
  reality_fracture:'\u25A7', mass_corruption:'\u2620', turret_ascension:'\u2739', overdrive_core:'\u269B',
  echo_blast:'\u229B',
};
